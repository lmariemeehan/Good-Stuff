...
describe("Favorite", () => {
  ...
  describe("#create()", () => {
    ...
    it("should not create a favorite without assigned post or user", (done) => {
      ...
      .then((favorite) => {
        //this code block will not be evaluated since it is missing the user and post ID's. We'll catch the error in the catch block below.
        done();
      })
      .catch((err) => {
  ...
  describe("#setUser()", () => {
    it("should associate a favorite and a user together", (done) => {
      ...
      .then((favorite) => {
        this.favorite = favorite; //storing Favorite
        expect(favorite.userId).toBe(this.user.id); //confirming this was created for this.user
      ...
      .then((newUser) => {
        this.favorite.setUser(newUser) //change the favorite's user reference to newUser
        .then((favorite) => {
  ...
  describe("#setPost()", () => {
    it("should associate a post and a favorite together", (done) => {
      ...
      .then((favorite) => {
        this.favorite = favorite; //store the favorite
