...
const User = require("../../src/db/models").User;
  ...
  describe("routes : posts", () => {
    ...
    //GUEST USER ONLY AUTHORIZED TO VIEW POSTS
     describe("guest user performing partial CRUD actions for Post", () => {
       beforeEach((done) => {
         request.get({
       ...
       describe("POST /topics/:topicId/posts/:id/update", () => {
          it("should NOT! update the post with the given values", (done) => {
              request.post(options,
                ...
                .then((post) => {
                  expect(post.title).toBe("Snowman Building Competition"); //confirm nothing has been changed
    ...
    //SIGNED IN MEMBER HAS FULL ACCESS WITH POSTS
    describe("signed in member performing CRUD actions for Post", () => {
           beforeEach((done) => {
             User.create({
    ...
    //ADMIN USER HAS FULL ACCESS WITH POSTS
